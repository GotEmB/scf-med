...
class module.exports extends React.Component
  @displayName: "MedicalsTable"

  @propTypes:
    medicals: React.PropTypes.arrayOf reactTypes.medical
    selectedMedical: reactTypes.medical
    onMedicalClick: React.PropTypes.func
  ...
  handleRowClicked: (row) =>
    @props.onMedicalClick? row

  handlePrintClicked: (row, e) =>
    printView = <MedicalPrintView medical={row} />
  ...
  render: ->
    <div className="table-responsive">
      <table className="table table-hover table-striped">
        ...
        <tbody>
          {@renderRow row, i for row, i in @props.medicals}
        </tbody>
      </table>
    </div>
